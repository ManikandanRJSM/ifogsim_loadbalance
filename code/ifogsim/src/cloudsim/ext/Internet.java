...
import cloudsim.ext.servicebroker.ClosestDataCenter;
...
public class Internet extends CloudSim implements CloudsimObservable {
	...
	private Map<Integer, ClosestDataCenter> serviceBrokers = new HashMap<Integer, ClosestDataCenter>();
	...
	public void addServiceBroker(int appId, ClosestDataCenter broker){
...
//            System.out.println(GridSim.clock() + ": Internet got:" + ev.get_tag() + " from " + ev.get_src() + " with data=" + ev.get_data());
	...
	private void processEvent(Sim_event ev){
        ...
        case Constants.REQUEST_INTERNET_CLOUDLET_TAG:
        	...
        	ClosestDataCenter serviceBroker = serviceBrokers.get(appId);
